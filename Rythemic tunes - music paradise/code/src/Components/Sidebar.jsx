...
const Sidebar = () => {
  ...
  <strong style={{display:"flex",justifyContent:"center",fontSize:"30px"}}>Music Paradise</strong>
       <div style={{marginTop:"35px"}}>
         <p style={{fontWeight: "bold", textAlign: "center", letterSpacing: "2px", marginBottom: "10px"}}>SONGS LIST</p>
         <li>
            <Link to="/songs">
